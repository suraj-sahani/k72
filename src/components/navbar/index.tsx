...
const navLinks = [
  {
    label: 'Agence',
    hover_label: 'Pour Tout voir',
    href: '/agence',
    hover_media_type: 'image',
    hover_thumb_1: NavAgenceThumb1,
    hover_thumb_2: NavAgenceThumb2,
  },
  {
    label: 'Projets',
    hover_label: 'Pour Tout voir',
    href: '/projects',
    hover_media_type: 'image',
    hover_thumb_1: NavProjectThumb1,
    hover_thumb_2: NavProjectThumb2,
  },
  {
    label: 'Contact',
    hover_label: 'Pour Tout voir',
  ...
  },
  {
    ...
    href: '/blogue',
    hover_media_type: 'image',
    hover_thumb_1: NavBlogThumb1,
    hover_thumb_2: NavBlogThumb2,
  },
] as const
    ...
    <>
      ...
      >
        <div className="relative h-full w-full">
          ...
          <div
            className="link_container flex h-full w-full items-center justify-center"
            style={{ opacity: 0 }}
            ...
            <ul className="w-full">
              {navLinks.map((item, index) => (
                <li key={item.label + index}>
                  <DrawerLinkItem key={index} item={item} />
                </li>
              ))}
            </ul>
          </div>
